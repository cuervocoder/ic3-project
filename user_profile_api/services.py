...
from user_profile_api.urls_services import URL_SEARCH_USER, URL_RECORD_USER, URL_DELETE_USER, URL_MODIFY_USER
...
def delete_user():
    ...
    if ENVIRONMENT == 'PROD':
        ...
        res = requests.put(full_url, headers=headers, data=payload, auth=HTTPDigestAuth(GATEWAY_USER, GATEWAY_PASSWORD))	
        data = res.json()
      #  print(request.validated_data)
